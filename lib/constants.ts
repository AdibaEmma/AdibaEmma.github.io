export const siteConfig = {
  ...
  description: "Senior Fullstack Engineer with 3+ years building scalable applications and microservices. Proven track record of delivering high-impact solutions that drive business growth.",
...
export const projects = [
  {
    ...
    description: "Contributed to developing SendAfrika's flagship fintech product with authentication functionalities and KYC modules, resulting in 40% increase in user onboarding efficiency.",
  ...
  },
  {
    ...
    description: "Pioneered development of a cutting-edge news aggregator app serving 15,000+ users with real-time tech news using advanced microservices architecture.",
  ...
  },
  {
    ...
    description: "Engineered high-performing microservice trading engine using Java, Spring Boot, and Redis, resulting in 20% monthly revenue boost through scalable architecture.",
    technologies: ["Java", "Spring Boot", "Redis", "Microservices", "WebSockets"],
    category: "backend",
  ...
  },
  {
    ...
    description: "Created secure blockchain wallet using Bitcore API with transaction endpoints for Bitcoin operations, implementing critical computations to ensure zero latency.",
  ...
  },
  {
    ...
    description: "Built comprehensive HR platform with admin monitoring, candidate management, and file upload to Cloudinary, achieving 45% improvement in server response time.",
    technologies: ["React", "Node.js", "Express", "MongoDB", "Docker", "Cloudinary"],
    category: "fullstack",
  ...
  },
  {
    ...
    description: "Developed automated exam timetable generation system with QR code registration, increasing registration efficiency by 40%.",
...
export const workExperience = [
  ...
  },
  {
    ...
    technologies: ["Kotlin", "Spring Boot", "PostgreSQL", "Redis", "Java", "Flyway"]
  },
  {
    id: "softmelon",
...
export const aboutContent = {
  ...
  description: `with over 3 years of professional experience building scalable web applications and microservices. I specialize in modern JavaScript/TypeScript ecosystems, backend architectures, and have a proven track record of delivering high-impact solutions that drive business growth.
  ...
  When I'm not coding, I enjoy exploring new technologies, contributing to open-source projects, and mentoring fellow developers. I believe in continuous learning and staying at the forefront of technological innovation.`,
